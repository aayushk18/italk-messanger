...
const LoginPage = () => {
    ...
    //                     <div>
    //                         <span>Password </span>
    //                         <input type={ShowPass ? 'password' : 'text'} value={Form.password} onChange={(e) => setForm({ ...Form, password: e.target.value })} placeholder="enter your password" />
    //                         <button type='' onClick={() => setShowPass(!ShowPass)}>
    //                             {ShowPass ? <Eye /> : <EyeOff />}
    //                         </button>
    ...
    //                 </form>
    //             </div>
    //             <div>Create an Account <Link to='/signup' className='text-amber-200'>Sign Up</Link></div>
